          ...
          public function fullScan($dir, $level=-1) {
            ...
            foreach ($list as $key => $value) {
              ...
              if (is_dir($item)) {
                ...
                $currentDir=$pad."[".$value."]";
                $this->markup[]=$this->wrapDir($currentDir);
                ...
                if($res){
                  $result.= $currentDir .nl. $res;
                }
              }
              else{
                $currentFile=$pad.$value;
                $result.=$currentFile.nl;
                
                $this->markup[]=$this->wrapFile($currentFile);
              }
            }
